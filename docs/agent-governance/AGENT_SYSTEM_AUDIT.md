...
|---------------|----------------|--------------|-----------------|-------------------|------------------|-------------------------|----------|---------|-----------------------------|
| **principal-product-manager** | Product requirements, PM eval, product quality | HIGH — Clear product authority | product-manager, ai-product-strategist | PM eval scores, requirement docs | YES — Can block on product grounds | MEDIUM — May overlook visual quality | **KEEP** | Core product authority, Level 2 reviewer | Add visual quality awareness, evidence requirements |
| **principal-design-reviewer** | Visual quality, design parity, brand fit | HIGH — Critical visual QA | design-quality-reviewer, visual-systems-designer | Visual scores, blocker detection | YES — Can block on visual grounds | LOW — Evidence-based | **KEEP** | Core design authority, Level 2 reviewer | Already updated with strict rules |
...
| **test-eval-engineer** | Tests, evals, quality verification | HIGH — Quality infrastructure | qa-release-engineer | Test files, eval results | NO — Advisor only | LOW — Evidence-based | **KEEP (NEW)** | Core quality builder, Level 1 | Create new, merge qa-release-engineer |
...
| **agent-governance-auditor** | Audit agent system, recommend changes | HIGH — System governance | — | Audit reports, recommendations | YES — Can block weak agents | LOW — Independent oversight | **KEEP** | System governance, Level 4 | Add false approval detection |
| **cto-bar-raiser** | Final release quality bar | VERY HIGH — Release authority | qa-release-engineer | Release decisions, evidence checks | YES — Final authority | LOW — Evidence-based | **KEEP** | Release authority, Level 3 | Already has strong instructions |
...
| **principal-architect** | Architecture, routing, dependencies | HIGH — Technical direction | lead-architect, context-architect | ADRs, architecture docs | YES — Can block on architecture | MEDIUM — May overlook visual impact | **KEEP (CONDITIONAL)** | Architecture authority, Level 2 | Add conditional invocation rules |
...
| **product-manager** | PM work, product evals | MEDIUM — Duplicate role | principal-product-manager, ai-product-strategist | PM evals, docs | NO — Lower authority | MEDIUM — Redundant with principal | **MERGE** | Merge into principal-product-manager | Absorb any unique value |
| **ai-product-strategist** | AI product strategy | LOW — Niche use | principal-product-manager, product-manager | Strategy docs | NO — Niche only | MEDIUM — More text than value | **MERGE** | Merge into principal-product-manager | Absorb AI strategy guidance |
| **design-quality-reviewer** | Design review, visual QA | MEDIUM — Duplicate role | principal-design-reviewer | Design reviews | NO — Lower authority | MEDIUM — Redundant with principal | **MERGE** | Merge into principal-design-reviewer | Already absorbed |
| **lead-architect** | Architecture leadership | MEDIUM — Duplicate role | principal-architect, context-architect | Architecture docs | NO — Lower authority | MEDIUM — Redundant with principal | **MERGE** | Merge into principal-architect | Absorb any unique guidance |
| **context-architect** | Context organization | LOW — Weak value | lead-architect, principal-architect | Context maps | NO — Advisor only | HIGH — Creates more structure than value | **DELETE** | No clear value add | Merge any unique concepts into principal-architect |
...
| **qa-release-engineer** | QA, release management | MEDIUM — Partial duplicate | test-eval-engineer, cto-bar-raiser | QA plans, release checks | YES — Can block | LOW — Partial overlap with test-eval | **MERGE** | Merge into test-eval-engineer + cto-bar-raiser | Absorb unique release checks |
...
| **visual-systems-designer** | Visual systems | LOW — Niche use | principal-design-reviewer, visual-plan-architect | Visual systems docs | NO — Advisor only | MEDIUM — Overlaps with design agents | **MERGE** | Merge into visual-plan-architect | Absorb system design concepts |
...
|----------|-------|--------|
| **KEEP** | 8 | principal-product-manager, principal-design-reviewer, frontend-engineer, test-eval-engineer (new), fresh-review-agent, visual-plan-architect, agent-governance-auditor, cto-bar-raiser |
| **KEEP (CONDITIONAL)** | 3 | security-reviewer, principal-architect, research-analyst |
| **MERGE** | 7 | product-manager, ai-product-strategist, design-quality-reviewer, lead-architect, implementation-critic, qa-release-engineer, visual-systems-designer |
...
|-------|---------------|--------|
| **Level 4 — System Governance** | 1 | agent-governance-auditor |
| **Level 3 — Release Quality** | 1 | cto-bar-raiser |
| **Level 2 — Principal Reviewers** | 5 | principal-product-manager, principal-design-reviewer, security-reviewer (conditional), principal-architect (conditional), fresh-review-agent |
| **Level 1 — Builders** | 3 | frontend-engineer, test-eval-engineer, visual-plan-architect |

### By Responsibility Type (After Simplification)

| Type | Count (After) | Agents |
|------|---------------|--------|
| **Builders** | 3 | frontend-engineer, test-eval-engineer, visual-plan-architect |
| **Reviewers** | 5 | principal-product-manager, principal-design-reviewer, security-reviewer, principal-architect, fresh-review-agent |
| **Governance** | 2 | agent-governance-auditor, cto-bar-raiser |
...
1. **Strong Governance** — agent-governance-auditor and cto-bar-raiser provide oversight
2. **Evidence-Based Review** — fresh-review-agent has strong evidence requirements
3. **Clear Visual QA** — principal-design-reviewer has strict visual rules
...
1. **principal-product-manager** — Product authority, PM evals
2. **principal-design-reviewer** — Visual QA, design parity
3. **frontend-engineer** — UI implementation
4. **test-eval-engineer** (NEW) — Tests, evals, quality infrastructure
5. **fresh-review-agent** — Independent review
6. **visual-plan-architect** — Visual planning
7. **agent-governance-auditor** — System oversight
8. **cto-bar-raiser** — Final release authority
